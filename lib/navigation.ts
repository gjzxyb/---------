...
export const navigationTree: NavigationGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "组织结构", href: "/admin/base-data/organizations", roles: adminRoles },
      { title: "课程管理", href: "/admin/base-data/courses", roles: adminRoles },
      { title: "学生管理", href: "/admin/base-data/students", roles: adminRoles },
      { title: "教师管理", href: "/admin/base-data/teachers", roles: adminRoles },
      { title: "教学班与选课", href: "/admin/base-data/classes", roles: adminRoles },
